...
integration. The corresponding fork release for this branch is `v0.4.15+mw.6`.
...
```bash
pip install "pyftms @ git+https://github.com/michaelw/python-pyftms.git@v0.4.15+mw.6"
```
